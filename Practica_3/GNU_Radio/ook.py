...
import ook_epy_block_2 as epy_block_2  # embedded python block
import sip
import threading
...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_2 = epy_block_2.blk(fc=128000, samp_rate=4096000)
        ...
        self.blocks_multiply_const_vxx_0_1 = blocks.multiply_const_ff((2*math.pi*fd/(Rb*Sps)))
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 128000, 1, 0, 0)
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 2, 1000000))), True)
        self.analog_const_source_x_1 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 2)
        ...
        self.connect((self.analog_const_source_x_1, 0), (self.blocks_add_const_vxx_1, 0))
        self.connect((self.analog_random_source_x_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.interp_fir_filter_xxx_0_0, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_multiply_const_vxx_0_0, 0))
        self.connect((self.blocks_add_const_vxx_1, 0), (self.blocks_multiply_const_xx_0, 0))
        ...
        self.connect((self.blocks_multiply_const_xx_0, 0), (self.epy_block_2, 0))
        ...
        self.connect((self.epy_block_2, 0), (self.qtgui_freq_sink_x_1, 0))
        self.connect((self.epy_block_2, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.epy_block_1, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0_0, 0), (self.epy_block_2, 1))
    ...
    def set_Sps(self, Sps):
        ...
        self.blocks_multiply_const_vxx_0_1.set_k((2*math.pi*self.fd/(self.Rb*self.Sps)))
