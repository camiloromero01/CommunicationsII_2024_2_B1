...
import practica1b1_epy_block_1 as epy_block_1  # embedded python block
import practica1b1_epy_block_2 as epy_block_2  # embedded python block
import sip
...
class practica1b1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_number_sink_2.set_title("Diferenciador")
        ...
        for i in range(1):
            self.qtgui_number_sink_2.set_min(i, -10000)
            self.qtgui_number_sink_2.set_max(i, 10000)
        ...
        self.qtgui_number_sink_2.set_block_alias("Diferenciador")
        ...
        self.qtgui_number_sink_1.set_title("Promedio")
        ...
        for i in range(1):
            self.qtgui_number_sink_1.set_min(i, -10000)
        ...
        self.qtgui_number_sink_1.set_block_alias("Promedio")
        ...
        self.qtgui_number_sink_0_1.set_title("Vector con ruido")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_1.set_min(i, -10000)
            self.qtgui_number_sink_0_1.set_max(i, 10000)
        ...
        self.qtgui_number_sink_0_0.set_title("Vector inicial")
        ...
        for i in range(1):
            self.qtgui_number_sink_0_0.set_min(i, -10000)
            self.qtgui_number_sink_0_0.set_max(i, 10000)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((5, 2, 2), True, 1, [])
        self.blocks_add_xx_0 = blocks.add_vff(1)
        self.analog_noise_source_x_0 = analog.noise_source_f(analog.GR_GAUSSIAN, 20, 0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.qtgui_number_sink_0_1, 0))
        ...
        self.connect((self.epy_block_2, 0), (self.qtgui_number_sink_1, 0))
